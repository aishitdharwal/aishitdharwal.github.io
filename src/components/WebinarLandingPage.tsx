...
function StuckAtCheckbox({ point, index, onToggle }: { point: string; index: number; onToggle: (index: number, checked: boolean) => void }) {
  ...
  return (
    <div className="flex items-start gap-3 p-4 bg-gray-900 rounded-lg border border-gray-800 transition-all duration-300 hover:border-gray-700 hover:border-orange-500/50 hover:shadow-lg hover:shadow-orange-500/10 group">
      ...
      <p className="text-gray-300 cursor-pointer transition-colors duration-300 group-hover:text-white" onClick={handleToggle}>
        {point}
      </p>
    </div>
  );
...
const testimonials = [
  {
    quote: "Built my first working MVP in 2 hours! The step-by-step approach made complex concepts incredibly simple. Now I'm launching my startup.",
    name: "Sarah Chen",
  ...
  {
    quote: "From confusion to clarity in 120 minutes. The no-code tools opened up a whole new world of possibilities for me.",
    name: "Lisa Park",
...
const learningPoints = [
  ...
  "Build a functional MVP using no-code/low-code tools in under 2 hours", 
...
const faqs = [
  {
    ...
    answer: "No! This webinar is designed for non-technical founders. We use no-code tools and visual builders that anyone can master.",
    isOpen: false
  },
  {
  ...
  {
    question: "Will I really build something in 120 minutes?",
    answer: "Yes! You'll have a working MVP by the end. We focus on speed and validation, not perfection. Launch fast, iterate faster.",
    isOpen: false
  },
  {
    ...
    <div className="min-h-screen bg-black" style={{ fontFamily: 'Roboto, -apple-system, BlinkMacSystemFont, "Segoe UI", system-ui, sans-serif' }}>
      ...
      <section className="px-4 py-12 text-center space-y-6 bg-black">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="inline-block">
            <Badge className="bg-gray-800 text-gray-300 font-black px-4 py-2 text-sm rounded-full border border-gray-600">
              120-Min Workshop at INR99/-
            </Badge>
          </div>
          ...
          <Card className="border-2 border-gray-700 bg-gray-900 overflow-hidden">
            <CardContent className="p-0">
              ...
              <div className="p-3 bg-gray-900">
                <p className="text-white text-sm font-black mb-1">👋 Meet Your Coach</p>
        ...
        <div className="max-w-lg mx-auto space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-gray-800/60 rounded-2xl p-4 space-y-2 border border-gray-700/50 transition-all duration-300 hover:bg-gray-800 hover:border-gray-600">
              ...
              <p className="text-white font-black text-lg">120 Mins</p>
            </div>
          </div>
          ...
          <div className="pt-2">
            <Button 
              size="lg" 
              className="w-full bg-orange-500 hover:bg-orange-600 text-white font-black text-lg py-4 rounded-2xl border-0"
            >
      ...
      <section className="px-4 py-8 space-y-6 bg-black">
        <div className="text-center space-y-3">
          <h2 className="text-2xl font-black text-white">What You Will Learn</h2>
      ...
      <section className="relative overflow-hidden bg-gray-900">
        ...
        <div className="px-4 py-8">
          <h2 className="text-2xl font-black text-white text-center mb-8">What Students Say</h2>
                  ...
                  <CardContent className="p-4 space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-orange-400 font-black">{testimonial.role}</p>
      ...
      <section className="px-4 py-8 space-y-6 bg-black">
        <div className="text-center">
          <h2 className="text-2xl font-black text-white">This Is For You If You Are</h2>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 max-w-lg mx-auto">
          {targetAudience.map((item, index) => (
            <div key={index} className="relative">
              <Card 
                className="border-2 border-gray-700 bg-gray-900 hover:border-gray-600 transition-all duration-300 cursor-pointer transform hover:scale-105 h-full group"
              ...
              >
                <CardContent className="p-6 text-center space-y-3 h-full flex flex-col justify-center">
                  <div className="w-12 h-12 bg-gray-700 rounded-xl mx-auto flex items-center justify-center transition-all duration-300 group-hover:bg-gray-600 group-hover:border-2 group-hover:border-orange-500 group-hover:shadow-lg group-hover:shadow-orange-500/20">
                ...
                <div className={`absolute z-20 w-72 max-w-[calc(100vw-2rem)] ${
                  ...
                  <div className="bg-gray-800 border border-gray-600 rounded-lg p-4 shadow-xl animate-in fade-in-0 zoom-in-95 duration-200">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-gray-300 text-sm leading-relaxed">{item.popup}</p>
                      <button 
      ...
      <section className="px-4 py-8 space-y-6 bg-black">
        <div className="text-center">
          <h2 className="text-2xl font-black text-white">Are You Still Stuck at</h2>
        </div>
              ...
              <div className="relative text-center p-6 bg-gradient-to-b from-gray-800/80 to-gray-900/80 rounded-2xl border border-gray-600/50 backdrop-blur-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <Button 
                      size="lg" 
                      className="bg-orange-500 hover:bg-orange-600 text-white font-black px-10 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                    >
                      Confirm My Seat
                    </Button>
                  </div>
      ...
      <section className="px-4 py-12 bg-gray-900">
        <div className="max-w-lg mx-auto space-y-6">
          <h2 className="text-2xl font-black text-white text-center">Meet Your Coach</h2>
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 space-y-1">
                  <h3 className="text-xl font-black text-white">Head of AI - Skooc</h3>
                  <p className="text-orange-400 font-black text-sm">IITB Alumni</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-gray-900 rounded-lg border border-gray-700">
                  <div className="text-2xl font-black text-orange-500">4000+</div>
                  <div className="text-xs text-gray-400">Mentees</div>
                </div>
                <div className="text-center p-3 bg-gray-900 rounded-lg border border-gray-700">
                  <div className="text-2xl font-black text-orange-500">400+</div>
                  <div className="text-xs text-gray-400">Masterclasses</div>
                </div>
              </div>
      ...
      <section className="px-4 py-12 bg-black">
        <div className="max-w-lg mx-auto space-y-8">
          ...
          <div className="space-y-8">
            {/* Lifetime Access */}
            <div className="text-center space-y-3">
              <h3 className="text-xl font-black text-gray-300">Lifetime Access</h3>
            ...
            {/* 100% Refund Policy */}
            <div className="text-center space-y-3">
              <h3 className="text-xl font-black text-gray-300">100% Refund Policy</h3>
              <p className="text-gray-400 text-sm">
            ...
            {/* Free Upgrades */}
            <div className="text-center space-y-3">
              <h3 className="text-xl font-black text-gray-300">Free Upgrades</h3>
              <p className="text-gray-400 text-sm">
          ...
          <Button size="lg" className="w-full bg-orange-500 hover:bg-orange-600 text-white font-black">
            Join the Workshop
          </Button>
        </div>
      </section>
      ...
      <section className="px-4 py-6 bg-black">
        <div className="max-w-lg mx-auto">
          <div className="text-center space-y-4">
            <p className="text-white font-black text-sm">⏰ Workshop Starts In:</p>
            <div className="grid grid-cols-4 gap-2">
              <div className="bg-gray-900 rounded-lg p-3 border border-gray-700">
                <div className="text-2xl font-black text-white animate-blink">{timeLeft.days}</div>
                <div className="text-xs text-gray-400">DAYS</div>
              </div>
              <div className="bg-gray-900 rounded-lg p-3 border border-gray-700">
                <div className="text-2xl font-black text-white animate-blink">{timeLeft.hours}</div>
                <div className="text-xs text-gray-400">HOURS</div>
              </div>
              <div className="bg-gray-900 rounded-lg p-3 border border-gray-700">
                <div className="text-2xl font-black text-white animate-blink">{timeLeft.minutes}</div>
                <div className="text-xs text-gray-400">MINS</div>
              </div>
              <div className="bg-gray-900 rounded-lg p-3 border border-gray-700">
                <div className="text-2xl font-black text-white animate-blink">{timeLeft.seconds}</div>
      ...
      <section className="px-4 py-8 space-y-6 bg-black">
        <div className="text-center">
          <h2 className="text-2xl font-black text-white">What You'll Be Able to Do After This</h2>
        </div>
      ...
      <section className="px-4 py-12 bg-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-lg mx-auto text-center space-y-8 relative z-10">
          ...
          <div className="pt-4">
            <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-white font-black px-8 py-4 text-lg transition-all duration-300 transform hover:scale-105">
              Grab your seat at just INR99/-
            </Button>
          </div>
          ...
          {faqs.map((faq, index) => (
            <Card key={index} className="border-2 border-gray-700 bg-gray-900 hover:border-orange-500/50 hover:shadow-lg hover:shadow-orange-500/10 transition-all duration-300">
              <CardContent className="p-0">
                ...
                >
                  <span className="font-black text-white text-sm">{faq.question}</span>
                  {openFaq === index ? (
